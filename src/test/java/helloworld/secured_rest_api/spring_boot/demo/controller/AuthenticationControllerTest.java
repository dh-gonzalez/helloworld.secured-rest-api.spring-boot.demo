...
import helloworld.secured_rest_api.spring_boot.demo.common.dto.AuthenticationRequestDTO;
import helloworld.secured_rest_api.spring_boot.demo.common.dto.TokenDTO;
    ...
    public void test_Authenticate_Nominal() {
        ...
        Authentication authentication =
                new UsernamePasswordAuthenticationToken("admin", "admin", Collections.singletonList(
                        new SimpleGrantedAuthority(Constants.authorityAdministrator)));
        ...
        StepVerifier.create(response).expectNext(tokenDTO).verifyComplete();
